...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            livingGhostsPos.append(inference.DiscreteDistribution.argMax(dist))


        for pos in livingGhostsPos:
        ...
        for action in legal:
            ...
            dist = self.distancer.getDistance(nearestGhostPos, successorPosition)
            if dist < minDist:
                minDist = dist
                best_action = action
