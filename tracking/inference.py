    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.allPositions:
            ...
            for new_pos in self.allPositions:
                temp[new_pos] = temp[new_pos]+ newPostDist[new_pos] * self.beliefs[pos]
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        partCountPerLoc = int(self.numParticles / len(self.legalPositions))

        for _ in range(partCountPerLoc):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                w *= self.getObservationProb(observation[i], gameState.getPacmanPosition(), particle[i], self.getJailPosition(i))
            dist[particle] += w
